      ...
      {carregando ? (
        ...
        <div style={{
          ...
          {filamentos.length === 0 && podeEditar && (
            <Link href="/workspace/estoque/novo" style={{ color: 'var(--purple)', fontSize: '13px' }}>
              ...
              >
                ...
                {podeEditar && (
                  <div style={{ marginTop: '14px', display: 'flex', gap: '8px' }}>
                    <button
                      onClick={() => router.push(`/workspace/estoque/${filamento.id}/editar`)}
                      style={{
