  ...
  if (erroCarregamento) {
    return (
      <div style={{ maxWidth: '640px', margin: '0 auto', textAlign: 'center', padding: '64px' }}>
        ...
        <button onClick={() => router.push('/dashboard/estoque')} style={{ color: 'var(--purple)', fontFamily: 'Inter, sans-serif', background: 'none', border: 'none', cursor: 'pointer', fontSize: '14px' }}>
          ← Voltar ao estoque
        </button>
      </div>
    )
